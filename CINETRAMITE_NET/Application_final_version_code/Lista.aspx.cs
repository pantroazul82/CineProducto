...
case when p.state_id=9 then p.fecha_notificacion_certificado when p.state_id=10 then p.fecha_final when p.state_id=14 then p.project_clarification_request_date else null end 'fecha_tramite_fin',
