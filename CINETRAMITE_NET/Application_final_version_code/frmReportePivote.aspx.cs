...
{
    public partial class frmReportePivote : System.Web.UI.Page
    {
        public bool showAdvancedForm = false;

        public string datos = " {color: \"blue\", shape: \"circle\"}, {color: \"red\", shape: \"triangle\"}";
        public string columnas = "\"Tipo_Obra\"";
        public string filas = "\"Clasificacion_Duracion\"";
        ...
        public void cargarDAtos()
        {
           ...
           // dataList.DataBind();
            ...
            for (int k = 0; k < tb.Rows.Count; k++)
            {
                ...
                {
                    datos += ""+tb.Columns[j].ColumnName.Trim()+":\""+tb.Rows[k][j].ToString().Trim()+"\"";
...
[project_total_cost_preproduccion]+[project_total_cost_produccion]+
[project_total_cost_posproduccion]+[project_total_cost_promotion] Costo_total,
