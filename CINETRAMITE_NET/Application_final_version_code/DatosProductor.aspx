<%@ Page Title="Formulario de datos del productor" Language="C#" MasterPageFile="~/Site.master" ValidateRequest="false"
    AutoEventWireup="true" CodeBehind="DatosProductor.aspx.cs" Inherits="CineProducto.DatosProductor"
            ...
            <fieldset>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="field_input">
                             <input type="text" name="participation_percentage" id="participation_percentage"
                                        runat="server" onkeypress='return validaNumericos(event)' maxlength="3" size="3"/>
                    ...
                    <li id="persona_juridica_field_group">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="field_input">
                                    <input type="text" name="producer_nit" id="producer_nit" runat="server" onkeypress='return validaNumericos(event)' maxlength="9" />
                        ...
                        <div class="field_input">
                            ...
                            <li>
                                <div class="field_label">
                                    Nombres del representante legal:<span class="required_field_text">*</span></div>
                                <div class="field_input">
                            ...
                            <li>
                                <div class="field_label">
                                    Apellidos del representante legal:<span class="required_field_text">*</span></div>
                                <div class="field_input">
                            ...
                            <li>
                                ...
                                <div class="field_input">
                                    <input type="text" name="identification_number_juridica" id="identification_number_juridica" runat="server" onkeypress='return validaNumericos(event)' maxlength="10"/></div>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <div class="field_group">
                            Datos de ubicación</div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="field_input">
                            <input type="text" maxlength="10" name="producer_phone" id="producer_phone" runat="server" onkeypress='return validaNumericos(event)' /></div>
                    </li>
                    <li>
                        <div class="field_label">
                            Teléfono alternativo:</div>
                        <div class="field_input">
                            <input type="text"  name="producer_movil" id="producer_movil" runat="server" onkeypress='return validaNumericos(event)' maxlength="10"/></div>
                    </li>
                    <li>
                        <div class="field_label">
