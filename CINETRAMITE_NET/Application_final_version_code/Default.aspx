			...
			<tbody>
                ...
                <tr>
                    ...
                    <td>
						...
						<div class="instrucciones">
                            <p>Diligencie los datos de su cuenta en <b>Ingreso para usuarios registrados</b> y pique sobre el botón acceder. 
Al ingresar puede <b>Crear</b> una nueva solicitud o <b>Consultar</b> las ya existentes.
      ...
      { %>
        ...
        <div class="row">
           ...
           <%if (Session["user_role_id"] != null && (Session["user_role_id"].ToString() == "0" || Session["user_role_id"].ToString() =="1"))
             { %>
                 <a href="Nuevo.aspx"><img alt="Crear" src="images/btn_crear_nueva_solicitud.png" /></a>
           <%} %>
        

              <%if (Session["user_role_id"] != null && Session["user_role_id"].ToString() == "7"){ %>
                      <a href="ListProjectos.aspx"><img alt="Consultar Proyectos" src="images/btn_consultar_mis_solicitudes.png" /></a>
                <%} else { %> 
                <a href="Lista.aspx"><img alt="Consultar" src="images/btn_consultar_mis_solicitudes.png" /></a>
                <%} %>
  ...
  <div class="span-9 last">
    ...
    <div class="span-9 last">
        <form method="post" action="" id="autenticacion_rapida">
            ...
            <div class="autenticacion_rapida">
                <span style="color:red"><asp:Label ID="auth_error_message" runat="server"></asp:Label></span>
                <fieldset>
    ...
    <div class="clear span-9 last">
        <span style="color:green"><asp:Label ID="confirmacion_creacion_cuenta" runat="server"></asp:Label></span>
        <span style="color:red"><asp:Label ID="error_creacion_cuenta" runat="server"></asp:Label></span>
        <form method="post" name="form" action="">
            <table cellspacing="0" class="register-form">
                    ...
                    <tr>
                        ...
                        <td><input maxlength="200" type="text" name="nombre_form" /></td>
                    </tr>
                    <tr>
                        <td class="label">Apellidos:</td>
                        <td><input maxlength="200" type="text" name="apellido_form" /></td>
                    </tr>
                    <tr>
                        <td class="label">Correo:</td>
                        <td><input maxlength="200" type="text" name="email_form" /></td>
		            </tr>
                        <tr>
                        ...
                        <td><input maxlength="200" type="text" name="txtcaptcha" /></td>
		            </tr>
		            <tr>
