...
{
    public partial class ProductoresAdicionales3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            * página principal */
            ...
            dtDomesticProducer.Columns.Add("producer_firstname2", typeof(string));
            dtDomesticProducer.Columns.Add("producer_lastname2", typeof(string));
            dtDomesticProducer.Columns.Add("producer_nit", typeof(string));
            dtDomesticProducer.Columns.Add("producer_nit_dig_verif", typeof(int));
            dtDomesticProducer.Columns.Add("participation_percentage", typeof(string));
            dtDomesticProducer.Columns.Add("id_genero", typeof(string));
            dtDomesticProducer.Columns.Add("id_etnia", typeof(string));
            ...
            dtForeignProducer.Columns.Add("producer_firstname2", typeof(string));
            dtForeignProducer.Columns.Add("producer_lastname", typeof(string));
            dtForeignProducer.Columns.Add("producer_lastname2", typeof(string));
            dtForeignProducer.Columns.Add("producer_nit", typeof(string));
            dtForeignProducer.Columns.Add("producer_nit_dig_verif", typeof(int));
            dtForeignProducer.Columns.Add("participation_percentage", typeof(string));
            dtForeignProducer.Columns.Add("id_genero", typeof(string));
            dtForeignProducer.Columns.Add("id_etnia", typeof(string));

            dtForeignProducer.Columns.Add("id_grupo_poblacional", typeof(string));
            dtForeignProducer.Columns.Add("fecha_nacimiento", typeof(string));
            dtForeignProducer.Columns.Add("abreviatura", typeof(string));
            dtForeignProducer.Columns.Add("primer_nombre_sup", typeof(string));
            dtForeignProducer.Columns.Add("segundo_nombre_sup", typeof(string));
            dtForeignProducer.Columns.Add("primer_apellido_sup", typeof(string));
            dtForeignProducer.Columns.Add("segundo_apellido_sup", typeof(string));
            ...
            if (Session["project_id"] != null)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    project_status ps = neg.getProjectStatus(Convert.ToInt32(Session["project_id"]), 3);
                    if(ps != null)
                    {
            ...
            if (requesterProducerContextInfo != -1)
            {
                ...
                if (project.producer[requesterProducerContextInfo].person_type_id == 2)
                    ...
                    nombre_productor.Text = project.producer[requesterProducerContextInfo].producer_firstname.Trim() + " " + project.producer[requesterProducerContextInfo].producer_firstname2.Trim() + " " + project.producer[requesterProducerContextInfo].producer_lastname.Trim() + " " + project.producer[requesterProducerContextInfo].producer_lastname2.Trim() + " ";
            ...
            if (Request.Form["change_producer_info"] != null || Request.Form["add_producer_info"] != null || Request.Form["save_producer_info"] != null)
            {
                ...
                //tooltip_producer_firstname_juridica2.Text = db.GetTooltip("producer_firstname_juridica2");
                //tooltip_producer_lastname_juridica2.Text = db.GetTooltip("producer_lastname_juridica2");
                ...
                if (producer_type.Value == "2")
                {
                    ...
                    lblNit.Text = "ID: ";
                    lblCedula.Text = "ID: ";
                    lblCedulaObligatoria.Text = "";
                    lblNitObligatorio.Text = "";
                }
                ...
                if (Request.Form["change_producer_info"] != null)
                {
                    ...
                    if (!(requesterProducer == -1))
                    {
                        ...
                        //else {
                        //    companyTypeDDL.SelectedValue = "7";
                        //    companyTypeDDL.Enabled = false;
                        //}
                        ...
                        producer_firstname2.Value = project.producer[requesterProducer].producer_firstname2;
                        producer_lastname.Value = project.producer[requesterProducer].producer_lastname;
                        producer_lastname2.Value = project.producer[requesterProducer].producer_lastname2;
                        ...
                        producer_nit_dig_verif.Value = project.producer[requesterProducer].producer_nit_dig_verif.ToString();

                        participation_percentage.Value = project.producer[requesterProducer].participation_percentage.ToString().Replace(",", ".");
                        cmbGenero.SelectedValue = project.producer[requesterProducer].id_genero.ToString();
                        cmbEtnia.SelectedValue = project.producer[requesterProducer].id_etnia.ToString();

                        cmbGrupoPoblacional.SelectedValue = project.producer[requesterProducer].id_grupo_poblacional.ToString();
                        if (project.producer[requesterProducer].fecha_nacimiento != null)
                        {
                            DateTime fecha_nac = DateTime.Parse(project.producer[requesterProducer].fecha_nacimiento.ToString());
                            fecha_nacimiento.Value = fecha_nac.Year + "-" + fecha_nac.Month + "-" + fecha_nac.Day;
                        }
                        abreviatura.Value = project.producer[requesterProducer].abreviatura;
                        primer_nombre_sup.Value = project.producer[requesterProducer].primer_nombre_sup;
                        segundo_nombre_sup.Value = project.producer[requesterProducer].segundo_nombre_sup;
                        primer_apellido_sup.Value = project.producer[requesterProducer].primer_apellido_sup;
                        segundo_apellido_sup.Value = project.producer[requesterProducer].segundo_apellido_sup;
                        ...
                        producer_firstname_juridica2.Value = project.producer[requesterProducer].producer_firstname2;
                        producer_lastname_juridica2.Value = project.producer[requesterProducer].producer_lastname2;
                        ...
                        //producer_firstname2.Attributes["Class"] = (project.producer[requesterProducer].producer_firstname2 == "") ? "required_field" : "";
                        producer_lastname.Attributes["Class"] = (project.producer[requesterProducer].producer_lastname == "") ? "required_field" : "";
                        //producer_lastname2.Attributes["Class"] = (project.producer[requesterProducer].producer_lastname2 == "") ? "required_field" : "";
                        producer_firstname_juridica.Attributes["Class"] = (project.producer[requesterProducer].producer_firstname == "") ? "required_field" : "";
                        producer_lastname_juridica.Attributes["Class"] = (project.producer[requesterProducer].producer_lastname == "") ? "required_field" : "";
                        producer_firstname_juridica2.Attributes["Class"] = (project.producer[requesterProducer].producer_firstname2 == "") ? "required_field" : "";
                        producer_lastname_juridica2.Attributes["Class"] = (project.producer[requesterProducer].producer_lastname2 == "") ? "required_field" : "";
                        ...
                        producer_nit_dig_verif.Attributes["Class"] = (project.producer[requesterProducer].producer_nit_dig_verif == -1) ? "required_field" : "";

                        cmbEtnia.Attributes["Class"] = (project.producer[requesterProducer].id_etnia == -1) ? "required_field" : "";

                        cmbGrupoPoblacional.Attributes["Class"] = (project.producer[requesterProducer].id_grupo_poblacional == -1) ? "required_field" : "";
                        fecha_nacimiento.Attributes["Class"] = (project.producer[requesterProducer].fecha_nacimiento.ToString() == "") ? "required_field" : "";
                        abreviatura.Attributes["Class"] = (project.producer[requesterProducer].abreviatura == "") ? "required_field" : "";
                        primer_nombre_sup.Attributes["Class"] = (project.producer[requesterProducer].primer_nombre_sup == "") ? "required_field" : "";
                        segundo_nombre_sup.Attributes["Class"] = (project.producer[requesterProducer].segundo_nombre_sup == "") ? "required_field" : "";
                        primer_apellido_sup.Attributes["Class"] = (project.producer[requesterProducer].primer_apellido_sup == "") ? "required_field" : "";
                        segundo_apellido_sup.Attributes["Class"] = (project.producer[requesterProducer].segundo_apellido_sup == "") ? "required_field" : "";

                        cmbGenero.Attributes["Class"] = (project.producer[requesterProducer].id_genero == -1) ? "required_field" : "";
                        participation_percentage.Attributes["Class"] = (project.producer[requesterProducer].participation_percentage == 0) ? "required_field" : "";
                ...
                List<Attachment> adjuntos = adjuntoObj.GetAttachmentListByConsult(project, 1, this.producer_id_additional);
                if (producer_type.Value == "2")
                {
                    adjuntos = adjuntoObj.GetAttachmentListByConsult(project, 1, this.producer_id_additional, false);
                }
                    ...
                    if (producer_type.Value.Trim() != string.Empty)
                    {
                        ...
                        if (requesterProducer == -1)
                        {
                            ...
                            else if (newProducer.person_type_id == 2)
                            {
                                ...
                                newProducer.producer_firstname2 = producer_firstname_juridica2.Value;
                                newProducer.producer_lastname2 = producer_lastname_juridica2.Value;
                                ...
                                newProducer.primer_nombre_sup = primer_nombre_sup.Value;
                                newProducer.segundo_nombre_sup = segundo_nombre_sup.Value;
                                newProducer.primer_apellido_sup = primer_apellido_sup.Value;
                                newProducer.segundo_apellido_sup = segundo_apellido_sup.Value;
                        ...
                        else
                        {
                            ...
                            if (project.producer[requesterProducer].person_type_id == 1)
                            {
                                ...
                                project.producer[requesterProducer].producer_firstname2 = producer_firstname2.Value;
                                project.producer[requesterProducer].producer_lastname2 = producer_lastname2.Value;
                            ...
                            else if (project.producer[requesterProducer].person_type_id == 2)
                            {
                                ...
                                project.producer[requesterProducer].producer_firstname2 = producer_firstname_juridica2.Value;
                                project.producer[requesterProducer].producer_lastname2 = producer_lastname_juridica2.Value;
                            ...
                            project.producer[requesterProducer].primer_nombre_sup = primer_nombre_sup.Value;
                            project.producer[requesterProducer].segundo_nombre_sup = segundo_nombre_sup.Value;
                            project.producer[requesterProducer].primer_apellido_sup = primer_apellido_sup.Value;
                            project.producer[requesterProducer].segundo_apellido_sup = segundo_apellido_sup.Value;
                        ...
                        Response.Redirect("ProductoresAdicionales3.aspx");
                        #endregion
                    }
                }
            }
                ...
                if (Session["project_id"] != null)
                {
                    foreach (Producer producer in project.producer)
                    {
                        if (producer.requester == 0)
                        {
                            ...
                            {
                                producer_title = producer.producer_firstname + " " + producer.producer_firstname2 + " " + producer.producer_lastname + " " + producer.producer_lastname2;
                            }
                            ...
                            if (producer.producer_type_id == 1) //Agrega la información del productor colombiano a la lista
                            {
                                ...
                                newRow["participation_percentage"] = "<li><div class='only_read_label'>Participación:</div><div class='only_read_value'>" + producer.participation_percentage.ToString() + "%</div></li>";
                                if (producer.participation_percentage == 0)
                                {
                                    informacionPendiente = true;
                                }
                                ...
                                newRow["producer_nit"] = (producer.person_type_id == 2) ? "<li><div class='only_read_label'>NIT:</div><div class='only_read_value'>" + producer.producer_nit + "-" + producer.producer_nit_dig_verif.ToString() + "</div></li>" : "";
                                ...
                                newRow["producer_firstname"] = (producer.person_type_id == 2) ? "<li><div class='only_read_label'>Nombres del representante legal:</div><div class='only_read_value'>" + producer.producer_firstname + " " + producer.producer_firstname2 + "</div></li>" : "<li><div class='only_read_label'>Nombres:</div><div class='only_read_value'>" + producer.producer_firstname + " " + producer.producer_firstname2 + "</div></li>";
                                if (producer.producer_firstname.Trim() == string.Empty)
                                {
                                    informacionPendiente = true;
                                }

                                newRow["producer_lastname"] = (producer.person_type_id == 2) ? "<li><div class='only_read_label'>Apellidos del representante legal:</div><div class='only_read_value'>" + producer.producer_lastname + " " + producer.producer_lastname2 + "</div></li>" : "<li><div class='only_read_label'>Apellidos:</div><div class='only_read_value'>" + producer.producer_lastname + " " + producer.producer_lastname2 + "</div></li>";
                                ...
                                newRow["producer_location"] = "<li><div class='only_read_label'>Datos de origen/Nacimiento:</div><div class='only_read_value'>" + producer.GetLocationDescription() + "</div></li>";
                                ...
                                newRow["producer_movil"] = (producer.producer_movil == "") ? "" : "<li><div class='only_read_label'>Tel&eacute;fono alternativo:</div><div class='only_read_value'>" + producer.producer_movil + "</div></li>";
                                ...
                                newRow["action_form"] = "<li>" + attachmentComplete + "<form action=\"\" method=\"post\" name=\"editproducer_" + producer.producer_id + "\"><input type='hidden' id='producer_id_origin' name='producer_id_origin' value='" + producer.producer_id + "' /><input  onclick='$(\"#loading\").show();' type='submit' name='change_producer_info' value='Por favor haga clic aquí para modificar la información del productor / Agregar adjuntos' /></form><br><br></li>";
                            ...
                            else if (producer.producer_type_id == 2) //Agrega la información del productor extranjero a la lista
                            {
                                ...
                                newRow["producer_nit"] = (producer.person_type_id == 2) ? "<li><div class='only_read_label'>ID:</div><div class='only_read_value'>" + producer.producer_nit + "</div></li>" : "";
                                ...
                                newRow["producer_firstname"] = (producer.person_type_id == 2) ? "<li><div class='only_read_label'>Nombres del Rep. Legal:</div><div class='only_read_value'>" + producer.producer_firstname + " " + producer.producer_firstname2 + "</div></li>" : "<li><div class='only_read_label'>Nombres:</div><div class='only_read_value'>" + producer.producer_firstname + " " + producer.producer_firstname2 + "</div></li>";
                                if (producer.producer_firstname == string.Empty)
                                {
                                    informacionPendiente = true;
                                }

                                newRow["producer_lastname"] = (producer.person_type_id == 2) ? "<li><div class='only_read_label'>Apellidos del Rep. Legal:</div><div class='only_read_value'>" + producer.producer_lastname + " " + producer.producer_firstname2 + "</div></li>" : "<li><div class='only_read_label'>Apellidos:</div><div class='only_read_value'>" + producer.producer_lastname + " " + producer.producer_lastname2 + "</div></li>";
                                if (producer.producer_lastname == string.Empty)
                                {
                                    informacionPendiente = true;
                                }

                                newRow["producer_identification_number"] = (producer.person_type_id == 2) ? "<li><div class='only_read_label'>ID del Rep. Legal:</div><div class='only_read_value'>" + producer.producer_identification_number + "</div></li>" : "<li><div class='only_read_label'>N&uacute;mero de identificaci&oacute;n:</div><div class='only_read_value'>" + producer.producer_identification_number + "</div></li>";
                    ...
                    for (int i = currentDomesticProducersQty; i < project.project_domestic_producer_qty - 1; i++)
                    {
                        ...
                        newRow["producer_nit"] = "";
                        newRow["producer_nit_dig_verif"] = -1;
                        newRow["producer_firstname"] = "";
                        newRow["producer_lastname"] = "";
                        newRow["producer_firstname2"] = "";
                        newRow["producer_lastname2"] = "";
                        newRow["producer_identification_number"] = "";
                        ...
                        newRow["action_form"] = "<li><form action=\"\" method=\"post\" name=\"newproducer\"><input type='hidden' id='producer_type_origin' name='producer_type_origin' value='1' /><input onclick='$(\"#loading\").show();'  type='submit' name='add_producer_info' value='Por favor haga clic aquí para registrar la información del productor'  /></form><br><br></li>";
                    ...
                    for (int i = currentForeignProducersQty; i < project.project_foreign_producer_qty; i++)
                    {
                        ...
                        newRow["action_form"] = "<li><form action=\"\" method=\"post\" name=\"newproducer\"><input type='hidden' id='producer_type_origin' name='producer_type_origin' value='2' /><input onclick='$(\"#loading\").show();' type='submit' name='add_producer_info' value='Por favor haga clic aquí para registrar la información del productor' /></form><br><br></li>";
            ...
            if (!IsPostBack) {
                lblAclaracionesSolicitadas.Text = project.sectionDatosProductoresAdicionales.solicitud_aclaraciones;
                txtAclaracionesProductor.Text = project.sectionDatosProductoresAdicionales.aclaraciones_productor;
            ...
            DominioCineProducto.NegocioCineProducto neg1 = new DominioCineProducto.NegocioCineProducto();            
            project_status ps1 = neg1.getProjectStatus(Convert.ToInt32(Session["project_id"]), 3);
            if (ps1!= null && ps1.project_status_revision_state_id == 10) {
        ...
        protected void btShowModal_Click(object sender, EventArgs e)
        {
            ...
            pcEditFormProducer.ContentUrl = "frmEditarCoproductor.aspx?project_producer_id=" + datosEnviados;
        ...
        protected void btShowModalVer_Click(object sender, EventArgs e)
        {
            LinkButton b = (LinkButton)sender;
            string datosEnviados = b.CommandArgument;
            pcVerCoProductor.ContentUrl = "frmVerCoproductor.aspx?project_producer_id=" + datosEnviados;
            pcVerCoProductor.ShowOnPageLoad = true;

        }
        
        protected void grdProdNal_BeforePerformDataSelect(object sender, EventArgs e)
        {
        ...
        public static void llenarGrids()
        {
        ...
        protected void radiobRevisarInfo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ps == null)
            {
                ...
                ps.project_status_section_id = 3;
        ...
        public bool CalcularVisible(object idProjectProducer)
        {
            DominioCineProducto.NegocioCineProducto neg = new DominioCineProducto.NegocioCineProducto();
            project_producer MyPp = neg.getProjectProducerById(Convert.ToInt32(idProjectProducer.ToString()));

            if (MyPp.project.state_id == 1)
            {
                return true;
            }
            else {
        ...
        protected bool EstanAprobadosAdjuntos(object producer_id)
        {
            bool retorno = true;
            NegocioCineProducto neg = new NegocioCineProducto();
            
            List<project_attachment> objPa = neg.getProjectAttachmentByProducerId(int.Parse(producer_id.ToString()));
        ...
        protected bool EstanRechazadosAdjuntos(object producer_id)
        {
            bool retorno = true;
            NegocioCineProducto neg = new NegocioCineProducto();
