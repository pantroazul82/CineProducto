<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListProjectos.aspx.cs" Inherits="CineProducto.ListProjectos" %>
    ...
    ExpandedText="Menos Filtros"     ExpandDirection="Vertical" />
       ...
       <tr>
           ...
           <td>
               ...
               <asp:SqlDataSource ID="SqlDataSourceTipoObra" runat="server" ConnectionString="<%$ ConnectionStrings:cineConnectionString %>" SelectCommand="SELECT [project_genre_id], [project_genre_name] FROM [project_genre] ORDER BY [project_genre_name]"></asp:SqlDataSource>
           </td>
       </tr>
       <tr>
           ...
           <td>
               ...
               <asp:SqlDataSource ID="SqlDataSourceDuracionObra" runat="server" ConnectionString="<%$ ConnectionStrings:cineConnectionString %>" SelectCommand="SELECT [project_type_id], [project_type_name] FROM [project_type] ORDER BY [project_type_name]"></asp:SqlDataSource>
           </td>
           ...
           <td>
               ...
               <asp:SqlDataSource ID="SqlDataSourceProductorPrincipal" runat="server" ConnectionString="<%$ ConnectionStrings:cineConnectionString %>" SelectCommand="SELECT [person_type_id], [person_type_name] FROM [person_type] ORDER BY [person_type_name]"></asp:SqlDataSource>
           </td>
       </tr>
<tr>
...
<SettingsPager ShowEmptyDataRows="True" PageSize="50"></SettingsPager>
         ...
         <Columns>
             ...
             <dx:GridViewDataTextColumn Settings-AutoFilterCondition="Contains" FieldName="Obra" ReadOnly="True" VisibleIndex="3" Caption="Obra">
             </dx:GridViewDataTextColumn>
             ...
             <dx:GridViewDataDateColumn  Settings-AutoFilterCondition="Contains"  FieldName="fecha_envio_aclaraciones"  PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy hh:mm:ss"   caption="Fecha Envio Aclaraciones" ReadOnly="True" VisibleIndex="10">
             </dx:GridViewDataDateColumn>
             ...
             <dx:GridViewDataDateColumn  Settings-AutoFilterCondition="Contains"  FieldName="fecha_resolucion" caption="Fecha Resolución" ReadOnly="True" VisibleIndex="12">
             </dx:GridViewDataDateColumn>
