<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReporteMaestro.aspx.cs" Inherits="CineProducto.frmReporteMaestro" %>
...
<asp:Label runat="server" Text="" ID="lblregistros"></asp:Label>
        ...
        <Columns>
             ...
             <dx:GridViewDataDateColumn Settings-AutoFilterCondition="Contains" FieldName="Fecha_Solicitud"  Caption="Fecha solicitud"  >
               ...
               <dx:GridViewDataTextColumn Settings-AutoFilterCondition="Contains" FieldName="Hora_Solicitud"  Caption="Hora solicitud"  >
                ...
                <dx:GridViewDataTextColumn Settings-AutoFilterCondition="Contains" FieldName="CoProductor" Caption="CoProductor"  />
                ...
                <dx:GridViewDataTextColumn Settings-AutoFilterCondition="Contains" FieldName="project_duration" Caption="Duración de la obra"  />
            ...
            <dx:GridViewDataDateColumn Settings-AutoFilterCondition="Contains" FieldName="fecha_limite" Caption="Fecha Limite" >
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" Height="30" /></dx:GridViewDataDateColumn>

            <dx:GridViewDataTextColumn Settings-AutoFilterCondition="Contains" Settings-AllowGroup="True" FieldName="responsable" Caption="Responsable"  />
