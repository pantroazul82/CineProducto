...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
   <style>
        ...
        .ajax__calendar_container {padding:4px;cursor:default;width: 180px !important;font-size:11px;text-align:center;font-family:tahoma,verdana,helvetica;}
        .ajax__calendar_dayname {height:17px; width:20px !important; text-align:right;padding:0 2px;}
        .ajax__calendar_day {height:17px;width: 20px !important;text-align:right;padding:0 2px;cursor:pointer;}
...
<div class="row "  style="width:100% !important;">
     <div class="col-12">
        <div class="pull-left">
        <span style="font-weight:bold;"><asp:Label ID="labelestadoproyecto" runat="server"></asp:Label></span><br />  
            <%if (project_state ==9) /* mostrar solo esto cuando es aprobado */
        { %>
        <span style="font-weight:bold;"><asp:Label ID="lblNumeroCertificado" runat="server"></asp:Label></span><br />
        <span style="font-weight:bold;"><asp:Label ID="lblFechaCertificado" runat="server"></asp:Label></span><br />
        <span style="font-weight:bold;"><asp:Label ID="lblFechaNotificacion" runat="server"></asp:Label></span><br />
...
<div class="row"  style="width:100% !important;">
    ...
    <div class="col-6">
        ...
        <fieldset>                <legend>Radicar la solicitud</legend><div >
            ...
            { %>
                ...
                <legend>Acciones de Flujo</legend>
                     <%if (bloquearSiguientePasoFlujo == false)
                         {%>
                            <div id="pasaraeditor_div" style="width:230px" class="final_link"><span>Pasar a editor</span>
         ...
         <%if (registrar_fecha_de_resolucion_permission)
            { %>
                <div id="resolution_date_register">
                    <!--fieldset>
                        <legend>Registro de la fecha de expedici&oacute;n del Certificado</legend-->
                        <div class="field_label"><label for="resolution_date">Fecha de expedici&oacute;n</label></div>
...
<div class="col-6">
        ...
        <asp:Panel runat="server" ID="panelRazonRechazo"  Visible="true"> 
                         <fieldset>
                         <legend><label for="txtRazonesRechazo">Razones de No aprobación <span class="form-required" ></span></label></legend>
                        ...
                        <asp:Button CssClass="boton" runat="server" Font-Size="16px" ID="btnGuardarCarta" Text="Guardar" OnClick="btnGuardarCarta_Click" />
                            <br />
                            <span style="color:red;"> <asp:Label ID="lblMsgRazonesRechazo" runat="server"></asp:Label></span> 
                            <br />
        ...
        <asp:Label runat ="server" ID="lblErrorAprobacion" Text="" ForeColor="Red"></asp:Label>
              ...
              <legend>Acciones Finales</legend>
                  ...
                  <div style="width:250px;">
                    ...
                    <div style="height:30px;text-align:center;line-height:30px" id="rechazarsolicitud1_div" class="accion_finalizar final_link"><span>Enviar carta de rechazo</span>
                        <input type="hidden" id="rechazarsolicitud1_field" name="rechazarsolicitud1_field" value="" /></div>
                    <br />
                    ...
                    <%}%>
                      ...
                      <%if (project_state !=9 && project_state != 10 && (user_role == 4 || user_role == 2 )){ %>
                         <fieldset>
                          ...
                          <div id="cancelarsolicitud1_div" style="width:250px;height:35px;text-align:center;line-height:35px"  class="accion_finalizar final_link"><span>Cancelar solicitud</span>
                              <input type="hidden" id="cancelarsolicitud1_field" name="cancelarsolicitud1_field" value="" /></div>
                                        </fieldset>
                      <%}%>
            <%}%>
            </div>
          ...
          <br />
            <div style="border-style:solid;border-color:lightblue;border-width:1px;">
                ...
                <b>Cargar nuevamente formulario de solicitud firmado</b><br />
                    <span id="name_formulario_solicitud">
                        Reemplazar el Formulario de solicitud firmado</span>
                   </div>
                    <div>
                            <div id='divFileUpload_formulario_solicitud'  >
                                <input type='file' name='file' id='FileUpload_formulario_solicitud' style='display:none' />  
...
<fieldset class="fieldset-final">
    <legend>Información Adicional</legend>
                <ul>
                    ...
                    <li>
                       <div class="field_label"><strong>Link protegido de la obra:</strong><span class="required_field_text">*</span>                            
                        </div>
                ...
                <table>
                    ...
                    <tr>
                        <td><div class="field_label"><strong> Adjuntos Adicionales:</strong><span class="required_field_text"></div></span></td>
                    </tr>
                   
                    <tr>
                        <td><img src="images/pdf.png" width="25px"> Archivo: <asp:FileUpload runat="server" ID="fileOtrosAdjuntos" /></td>
                    </tr>
                    <tr>
                        <td>Descripción: <asp:TextBox style="Width:90% " runat="server" ID="txtOtrosAdjuntos"> </asp:TextBox></td>
    ...
    <div class="col-6">
         <% if (user_role != 6) { %>
          <asp:Panel runat="server" ID="pnlAclaraciones" Visible="false">
            ...
            <asp:TextBox runat="server" Width="98%" Height="100px" ID="txtComplementoCartaAclaraciones" TextMode="MultiLine"
                ></asp:TextBox>
             <br />        

                   <div class="field_label"><b>Texto sustituto </b></div>
            <asp:TextBox runat="server" Width="98%" Height="100px" ID="txtSustitutoCartaAclaraciones" TextMode="MultiLine"
                ></asp:TextBox>
             <br />
               <% if (user_role != 6)
                   { %>
              ...
              { %>
                <div id="schedulefilmview">
                    <fieldset>
                        ...
                        <div class="field_label"><label for="schedulefilmview_result">Resultado de la visualización</label></div>
                        <div class="field_input"><textarea style="width:98%;min-height:100px;" rows="3" cols="70" name="schedulefilmview_result" id="schedulefilmview_result" class="user-input" runat="server"></textarea>
                        </div>
            ...
            <div class="row" style="width:100%;">
                    ...
                    <asp:Panel runat="server" ID="pnSuperAdmin" Visible="true">
                        <fieldset>
                            ...
                            Estado: <asp:TextBox runat="server" ID="txtEstadoSuperAdmin"></asp:TextBox>
                    ...
                    <br />
                            Archivo: <asp:FileUpload runat="server" ID="FileUploadCertificado" />
